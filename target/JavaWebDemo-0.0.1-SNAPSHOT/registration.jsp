...
<body>
                ...
                <div class="container">
 				...
 				<a href="Dashboard" class="btn btn-primary"><span class="glyphicon glyphicon-chevron-left"></span> Back</a>

                    <h2>UserRegistration</h2>

                    <form class="form-horizontal" role="form" action="UserRegister" id="RegisterForm" onsubmit="return validateForm()" name="RegisterForm" method="POST">
